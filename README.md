...
- 🍀**Fine-Tuning with CoT Data:** We develop _Marco-o1-CoT_ by performing full-parameter fine-tuning on the base model using open-source CoT dataset combined with our self-developed synthetic data. 
